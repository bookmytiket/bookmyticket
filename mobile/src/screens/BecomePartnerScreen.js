...
const CATEGORIES = [...SERVICE_CATEGORIES.map(c => c.name), "Other", "Turf Booking", "Catering", "Decorator"];

const ROLES = ["Individual", "Company", "Agency", "Others"];
  ...
  if (success) {
    return (
      <View style={styles.successContainer}>
        ...
        <Text style={styles.successSub}>A confirmation email has been sent. Our team will reach out to you within 24 hours.</Text>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  pickerItem: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: '#f1f5f9', marginRight: 8, borderWidth: 1, borderColor: 'transparent' },
  activePickerItem: { backgroundColor: '#8b5cf615', borderColor: '#8b5cf6' },
  pickerText: { fontSize: 14, color: Colors.textLight, fontWeight: '600' },
  activePickerText: { color: '#8b5cf6' },
  roleContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 4 },
  roleItem: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, borderWidth: 1, borderColor: '#e2e8f0' },
  activeRoleItem: { borderColor: '#8b5cf6', backgroundColor: '#8b5cf605' },
