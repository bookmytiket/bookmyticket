...
class Title {
    constructor({ gl, plane, renderer, text, textColor = '#000000', font = '30px sans-serif' }) {
        autoBind(this);
        this.gl = gl;
        this.plane = plane;
...
class GalleryApp {
    ...
    constructor(container, { items, bend = 1, textColor = '#000000', borderRadius = 0, font = 'bold 30px Figtree', scrollEase = 0.05, autoScrollSpeed = 0.3 }) {
    ...
    update() {
        // Auto-scroll: continuously advance the target
