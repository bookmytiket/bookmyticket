...
-- Primary Theme: Pink (#FF1493) and Purple (#8A2BE2)
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
    ...
    <div style="padding: 40px; color: #1e293b; line-height: 1.6;">
      ...
      <div style="margin-top: 30px; text-align: center;">
        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;margin:0 auto;">
          <tr>
            <td align="center" bgcolor="#FF1493" role="presentation" style="border:none;border-radius:14px;cursor:auto;background:linear-gradient(135deg, #FF1493 0%, #8A2BE2 100%);" valign="middle">
              <a href="{{site_url}}" style="display:inline-block;background:linear-gradient(135deg, #FF1493 0%, #8A2BE2 100%);color:#ffffff;font-family:''Segoe UI'', Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:800;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:18px 36px;border-radius:14px;" target="_blank">
                Explore Events
              </a>
            </td>
          </tr>
    ...
    <div style="padding: 30px; text-align: center; background-color: #f8fafc; border-top: 1px solid #f1f5f9;">
      ...
      <div style="margin-top: 15px;">
        <a href="https://bookmyticket.net" style="color: #FF1493; text-decoration: none; font-weight: 700; font-size: 13px;">Website</a>
        <span style="color: #cbd5e1; margin: 0 10px;">•</span>
        <a href="https://bookmyticket.net/events" style="color: #8A2BE2; text-decoration: none; font-weight: 700; font-size: 13px;">Events</a>
      </div>
    </div>
  </div>
</div>'
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
    ...
    <div style="padding: 40px; color: #1e293b; line-height: 1.6;">
      ...
      <p style="margin-top: 25px; font-size: 12px; color: #94a3b8; text-align: center;">
        ...
        <span style="color: #8A2BE2; word-break: break-all;">{{reset_link}}</span>
      </p>
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
    ...
    <div style="padding: 40px; color: #1e293b; line-height: 1.6;">
      ...
      <div style="background: #f8fafc; padding: 24px; border-radius: 16px; border: 1px solid #e2e8f0; margin: 24px 0;">
        ...
        <p style="margin: 8px 0 0 0; font-size: 16px; color: #1e293b;"><strong>Booking ID:</strong> <code style="background: #fff; padding: 4px 10px; border-radius: 6px; border: 1px solid #e2e8f0; color: #FF1493; font-weight: 700;">{{bookingId}}</code></p>
      </div>
      <div style="margin-top: 30px; text-align: center;">
        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;margin:0 auto;">
          <tr>
            <td align="center" bgcolor="#FF1493" role="presentation" style="border:none;border-radius:14px;cursor:auto;background:linear-gradient(135deg, #FF1493 0%, #8A2BE2 100%);" valign="middle">
              <a href="{{ticket_url}}" style="display:inline-block;background:linear-gradient(135deg, #FF1493 0%, #8A2BE2 100%);color:#ffffff;font-family:''Segoe UI'', Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:800;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:18px 36px;border-radius:14px;" target="_blank">
                View Digital Ticket
              </a>
            </td>
          </tr>
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #f1f5f9;">
    ...
    <div style="padding: 40px; color: #1e293b; line-height: 1.6; text-align: center;">
      ...
      <div style="margin: 32px 0;">
        <div style="display: inline-block; padding: 24px 48px; background: #fdf4ff; border: 2px dashed #8A2BE2; border-radius: 20px;">
          <span style="font-size: 36px; font-weight: 900; letter-spacing: 12px; color: #FF1493; font-family: ''Courier New'', Courier, monospace; margin-left: 12px;">{{otp}}</span>
        </div>
      </div>
