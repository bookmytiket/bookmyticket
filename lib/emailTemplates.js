...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;">
    <div style="max-w: 600px; margin: auto; background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <div style="margin-top: 20px;">
            <a href="${loginLink}" target="_blank" style="display: inline-block; padding: 12px 25px; background: #ec4899; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">Explore Events</a>
        </div>
        <p style="margin-top: 20px; font-size: 12px; color: #777;">
            If the button above doesn't work, copy and paste this link into your browser:<br/>
            <a href="${loginLink}" style="color: #ec4899;">${loginLink}</a>
        </p>
