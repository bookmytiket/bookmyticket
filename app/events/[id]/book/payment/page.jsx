...
export default function PaymentSimulationPage({ params }) {
            ...
            <div style={{ maxWidth: '500px', margin: '0 auto', padding: '0 20px' }}>
                    ...
                    <div style={{ padding: '24px' }}>
                        ...
                        {paymentStatus === 'success' && (
                            <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', padding: '16px', borderRadius: '12px', marginBottom: '24px', textAlign: 'center' }}>
                                ...
                                <p style={{ margin: '4px 0 0 0', fontSize: '12px', color: '#15803d' }}>Redirecting to your ticket...</p>
                            </div>
                        )}

                        {paymentStatus === 'fail' && (
                            <div style={{ background: '#fef2f2', border: '1px solid #fecaca', padding: '16px', borderRadius: '12px', marginBottom: '24px', textAlign: 'center' }}>
                                <AlertCircle size={32} color="#ef4444" style={{ marginBottom: '8px' }} />
                                <p style={{ margin: 0, fontSize: '14px', color: '#b91c1c', fontWeight: 700 }}>Payment Failed</p>
                                <p style={{ margin: '4px 0 0 0', fontSize: '12px', color: '#b91c1c' }}>Please check your credentials and try again.</p>
                            </div>
                        )}
                        ...
                        <p style={{ marginTop: '24px', fontSize: '11px', color: '#94a3b8', textAlign: 'center', lineHeight: 1.6 }}>
                            {paypalClientId ? "Secure payments processed via PayPal." : "This is a secure simulation for demonstration purposes. Directing to your chosen payment gateway would happen here in a live environment."}
                        </p>
                    </div>
                </div>
                ...
                <div style={{ marginTop: '32px', display: 'flex', justifyContent: 'center', gap: '24px', opacity: 0.6 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', fontWeight: 700 }}>
                        <ShieldCheck size={16} /> PCI Compliant
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', fontWeight: 700 }}>
