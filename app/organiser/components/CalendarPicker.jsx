            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute left-0 top-full z-[100] w-[320px] bg-white/95 backdrop-blur-xl border border-slate-100 rounded-[2.5rem] shadow-2xl p-6 select-none overflow-hidden"
                    >
                        {/* Header */}
